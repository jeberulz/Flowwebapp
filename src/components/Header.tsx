import { Bell, Command, ChevronDown, PanelLeft, Search, LucideIcon } from 'lucide-react';
  ...
  return (
    <header className="flex gap-3 items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <PanelLeft className="h-4.5 w-4.5 text-white" />
        </button>
        <div className="rounded-xl p-[1px] bg-gradient-to-br from-white/0 via-white/20 to-white/0">
          <div className="rounded-[inherit] px-3 py-2 flex items-center gap-2 ring-1 ring-white/10 bg-white/5 backdrop-blur-sm">
            ...
            <span className="text-sm tracking-tight text-white font-medium">Flow</span>
          </div>
        </div>
      </div>
        ...
        <div className="w-full rounded-2xl p-[1px] bg-gradient-to-br from-white/0 via-white/20 to-white/0">
          ...
          <div className="relative rounded-2xl px-3 py-2.5 flex items-center gap-2 ring-1 ring-white/10 bg-white/10 focus-within:ring-white/25 backdrop-blur-md">
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-sm text-white/80 placeholder-white/60"
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="rounded-2xl p-[1px] bg-gradient-to-br from-white/60 via-white/100 to-white/60">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl bg-white text-zinc-900 hover:bg-zinc-100 px-3.5 sm:px-4 py-2 text-sm font-medium tracking-tight transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900"
            type="button"
          >
            {PrimaryButtonIcon ? (
            ...
            <span className="hidden sm:inline text-sm">{primaryButtonText}</span>
          </button>
        </div>
        <button 
        ...
        >
          ...
          />
          <span className="hidden sm:inline text-sm font-medium text-white">Jay</span>
