  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 items-start mt-10 md:mt-16">
      ...
      <div className="lg:col-span-5">
        <div className="border-gradient before:rounded-2xl inline-flex items-center gap-2 rounded-2xl px-2.5 py-1.5" style={{ '--fx-filter': 'blur(10px)_liquid-glass(5,10)_saturate(1.2)_noise(0.5,1,0)' } as React.CSSProperties}>
        ...
        {/* Feature chips */}
          ...
          <div className="border-gradient before:rounded-2xl inline-flex hover:bg-white/[0.07] transition-colors rounded-2xl pt-1.5 pr-3 pb-1.5 pl-3 gap-2 items-center" style={{ '--fx-filter': 'blur(10px)_liquid-glass(5,10)_saturate(1.2)_noise(0.5,1,0)' } as React.CSSProperties}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-8">
          ...
          <button className="border-gradient before:rounded-2xl group inline-flex hover:bg-white/10 transition-all hover:-translate-y-0.5 text-sm text-white tracking-tight rounded-2xl pt-3 pr-4 pb-3 pl-4 gap-2 items-center justify-center" style={{ '--fx-filter': 'blur(10px)_liquid-glass(5,10)_saturate(1.2)_noise(0.5,1,0)' } as React.CSSProperties}>
        ...
        <div className="mt-6 grid grid-cols-3 gap-4 max-w-md">
          <div className="border-gradient before:rounded-3xl overflow-hidden aspect-[16/12] flex flex-col rounded-3xl pt-4 pr-4 pb-4 pl-4 relative items-center justify-center" style={{ '--fx-filter': 'blur(10px)_liquid-glass(5,10)_saturate(1.2)_noise(0.5,1,0.05)' } as React.CSSProperties}>
