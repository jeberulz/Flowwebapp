  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        <div className="border-gradient before:rounded-xl inline-flex items-center gap-2 rounded-xl px-3 py-2 backdrop-blur-[10px]">
      ...
      <div className="hidden sm:flex items-center gap-6 text-sm">
        ...
        <button className="border-gradient before:rounded-2xl inline-flex items-center gap-2 rounded-2xl px-4 py-2 text-sm transition-colors backdrop-blur-[10px] hover:bg-white/10">
